...
<head>
    ...
    <title>{{$datos_empresa->nombre}}</title>
...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">{{$datos_empresa->nombre}}</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="{{ asset("img/$datos_empresa->id.jpg") }}" alt="">
                    <div class="intro-text">
                        <span class="name">{{$datos_empresa->nombre}}</span>
                        <hr class="star-light">
                        <span class="skills">{{$datos_empresa->eslogan}}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-above">
            <div class="container">
                <div class="row">
                    ...
                    <p>"{{$datos_empresa->mision}}"</p>
                </div>
                <div class="footer-col col-md-6">
                        <h2>VISION</h2>
                        <p>"{{$datos_empresa->vision}}"</p>
                </div>
