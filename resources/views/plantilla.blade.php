...
<head>
    ...
    <title>Imagen Empresarial</title>
...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">NOMBRE DE LA EMPRESA</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="img/tec.png" alt="">
                    <div class="intro-text">
                        <span class="name">NOMBRE EMPRESA</span>
                        <hr class="star-light">
                        <span class="skills">ESLOGAN</span>
                    </div>
                </div>
            </div>
        </div>
